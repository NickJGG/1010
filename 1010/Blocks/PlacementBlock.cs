...
namespace _1010 {
    public class PlacementBlock : Block {
        public PlacementBlock(List<int[]> spots, Vector2? position = null, List<int[]> obstacles = null) : base(spots, position, obstacles) {
            Bits = new List<Bit>();
        }
        ...
        public bool DrawPlacingBits { get; set; } = true;
